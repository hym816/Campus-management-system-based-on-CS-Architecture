...
public class reviseFailure implements ContentPanel {

    private JPanel panel;

    public reviseFailure() {
        ...
        JLabel label = new JLabel("<html>抱歉，图书馆库存中暂无这本书。<br/>请添加书籍");
    ...
    private void switchToSearch() {
        ...
        if (topFrame instanceof MainWindowStu) {
            ((MainWindowStu) topFrame).switchContent("修改信息");
        }
    }
}
